 ...
 */
class CategoryRecycleAdapter (val context: Context, val categories: List<Category>, val itemCick: (Category) -> Unit ) : RecyclerView.Adapter<CategoryRecycleAdapter.Holder>() {
